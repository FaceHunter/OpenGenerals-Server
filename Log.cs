...
namespace CnCMaster
{
    // this file is completely stolen from NPServer, sorry bas :3
    // And i stole it from the T6 master, sorry convery :3
    ...
    public static class Log
    {
        ...
        public static Queue<string> logBuffer = new Queue<string>(10);
        public static Queue<string> logBufferLarge = new Queue<string>(200);
        ...
        private static void Write(String message, LogLevel level)
        {
            ...
            if (logBuffer.Count > 9)
                logBuffer.Dequeue();

            if (logBufferLarge.Count > 199)
                logBufferLarge.Dequeue();

            logBuffer.Enqueue(text);
            logBufferLarge.Enqueue(text);
